...
AForm::AForm() : _name(""), _isSigned(0), _requiredGrade(1)
{
#ifdef DEBUG
...
AForm::AForm(const std::string& name, bool isSigned, int requiredGrade) : _name(name), _isSigned(isSigned), _requiredGrade(requiredGrade)
{
#ifdef DEBUG
